...
const RetailerTaxManagementPage: React.FC = () => {
    ...
    const fetchTaxes = async () => {
        try {
            setLoading(true);
            const res = await retailerApi.getRetailerTaxes();
            if (res.data?.success) {
                setStats({
    ...
    return (
        <div style={{ padding: '24px', maxWidth: '1200px', margin: '0 auto' }}>
            <div style={{ marginBottom: '24px' }}>
                ...
                <Text type="secondary">Track VAT and excise duties collected from your sales.</Text>
            </div>
...
export default RetailerTaxManagementPage;
