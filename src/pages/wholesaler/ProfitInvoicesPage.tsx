...
import { Typography, Card, Table, Modal, Button, Descriptions } from 'antd';
import { FileTextOutlined, EyeOutlined } from '@ant-design/icons';
import { wholesalerApi } from '../../services/apiService';

const { Title, Text } = Typography;

export default function WholesalerProfitInvoicesPage() {
    ...
    const fetchInvoices = async () => {
        setLoading(true);
        try {
            const res = await wholesalerApi.getProfitInvoices();
